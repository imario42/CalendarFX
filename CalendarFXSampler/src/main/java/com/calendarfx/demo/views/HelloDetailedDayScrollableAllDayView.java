...
public class HelloDetailedDayScrollableAllDayView extends CalendarFXDateControlSample {

    private DetailedDayView dayView;

    @Override
    public String getSampleName() {
        return "Detailed Day View with scrollable All-Day View";
    }

    @Override
    public String getSampleDescription() {
        return "The detailed day view aggregates a day view, an scrollable all day view, a calendar header (for swimlane layout), and a time scale.";
    }
    ...
    protected DateControl createControl() {
        ...
        dayView.setAllDayScrollHeight(150.0);
        dayView.setShowAllDayScrollBar(true);
